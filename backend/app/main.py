...
# 🚀 Request Schema tightly bound with short premium model names from frontend UI dropdown
...
def analyze_trades(payload: AnalysisRequest):
    ...
    # 🔄 Frontend se aaya hua dynamic short-model key mapping pipeline me securely forward ho raha hai
